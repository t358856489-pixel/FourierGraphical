import { COMPONENT_COLOR_COUNT } from '../core/ranges'
...
export const readRenderTheme = (root: HTMLElement): RenderTheme => {
  ...
  return {
    background: readToken(style, '--screen-bg', FALLBACK_THEME.background),
    ...
    trace: readToken(style, '--screen-trace', FALLBACK_THEME.trace),
